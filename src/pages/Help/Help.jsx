    ...
    <React.Fragment>
      ...
      <div className="Help">
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">Perfil del usuario</h3>
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">Creación de un nuevo ambiente</h3>
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">Creación de un nuevo ambiente (Parte 2)</h3>
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">ID inexistente/equivocado</h3>
            <p className="Info__paragraph_kit">ID inexistente/equivocado
Si el ID registrado no existe o no es el correcto, se mostrará el siguiente mensaje. De ser este el caso, se tendrá la opción de eliminar el ambiente completo o cambiar únicamente el ID por uno nuevo, seleccione una de las dos opciones.</p>
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">Modificación de los ambientes</h3>
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">Modificación de los ambientes (Parte 2)</h3>
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">Eliminación de ambiente</h3>
        ...
        <div className="Info__help_img" >
          ...
          <div className="Info__help_info">
            <h3 className="Info__title_sensor font-face-ap">Cambio de la foto de perfil</h3>
            <p className="Info__paragraph_kit">Para realizar el cambio de la foto de perfil, será necesario ir al perfil del usuario y seleccionar el ícono de la cámara al lado de la foto, esto abrirá la galería de fotos de su celular, donde deberá seleccionarse la foto deseada.</p>
          </div>
        </div>
      </div>
